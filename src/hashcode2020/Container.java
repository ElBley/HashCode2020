    ...
    public String toString() {
        ...
        for (int i = 0; i < nBibl; i++) {
            ...
            if (nLibros != 0) {
                ...
                for (int j = 0; j < nLibros && nLibros < this.listaBibliotecas.size(); j++) {
                    if (!listaLibrosEnviados.get(this.listaBibliotecas.get(i).books.get(j).id)) {
                        listaLibrosEnviados.set(this.listaBibliotecas.get(i).books.get(j).id, Boolean.TRUE);
